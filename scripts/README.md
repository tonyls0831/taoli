...
- 同一則公告只警報一次，不會轟炸
- ⚠️ 觸發後的動作是人工的：到**預先開好**的台指週選下單匣執行雙買掃單
...
5. 兩種警報：合理價差**與上次比跳動 ≥10 點**（＝除息日估計跨過結算日邊界，馬克羊的進場訊號）；市場價差**偏離合理值 ≥8 點**
